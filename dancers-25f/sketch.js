...
function drawInstructionalText(){
  push();
  fill(150);
  text("Press 'A' to invite a dancer onto the floor", 100, 100);
  text("Press 'L' for strobe lights", 100, 120);
  text("Press 'S' for smoke", 100, 140);
  text("Press 'D' to make the oldest dancer go home", 100, 160);
  pop();
}
